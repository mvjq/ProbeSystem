...
class ProbeNavigationServiceTests {
  ...
  private final ProbeNavigationService underTest =
      new ProbeNavigationService(navigationServiceMock, dataAccessService);
  ...
  void createProbeNavigation_moveOutOfBounds_shouldMoveToPlanetLimit() throws Exception {
    ...
    List<Command> listOfCommands =
        List.of(Command.M, Command.M, Command.M, Command.M, Command.M, Command.M);
